...
基于 **Vue 3 + TypeScript** 实现的树形展示组件，**零第三方依赖**。
支持 **拖拽、排序、节点过滤、多选、自定义图标** 等功能，并可通过覆写内置 **CSS 变量** 灵活定制节点样式。

![预览图](public/images/preview_01.jpg)
...
import { ref } from 'vue';
import VueProjectTree from 'vue-project-tree';
import 'vue-project-tree/style.css';
...
<html>
  <head>
    ...
    <link rel="stylesheet" href="vue-project-tree.css" />
  </head>
  <body>
    <div id="app">
